...
Thank you for your interest in `icars-api`, an open source project
administered by StrongLoop.

Contributing to `icars-api` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/icar-api)
